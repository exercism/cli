...
var languagePatterns = map[string]Patterns{
	...
	"cpp":       {Matches: []string{"*.cpp"}, Except: []string{"_test.cpp"}},
	...
	"ecmascript": {Matches: []string{"*ts", "*.js"}, Except: []string{".spec.js", "gulpfile.js"}},
	// Note: I rename the lib files from exs to ex,
	"elixir":  {Matches: []string{"*.ex", "*.exs"}, Except: []string{"_test.exs"}},
